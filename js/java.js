...
function fillbag(){
  ...
  document.getElementById("st1").value=pr;
}
function b1(){
...
function b5(){
	...
	var wt1=parseInt(document.getElementById("wt1").value);
	var pt1=parseInt(document.getElementById("pt1").value);
	document.getElementById("wt01").value=wt1;
	document.getElementById("pt01").value=pt1;

	var wt2=parseInt(document.getElementById("wt2").value);
	var pt2=parseInt(document.getElementById("pt2").value);
	document.getElementById("wt02").value=wt2;
	document.getElementById("pt02").value=pt2;

	var wt3=parseInt(document.getElementById("wt3").value);
	var pt3=parseInt(document.getElementById("pt3").value);
	document.getElementById("wt03").value=wt3;
	document.getElementById("pt03").value=pt3;

	var wt4=parseInt(document.getElementById("wt4").value);
	var pt4=parseInt(document.getElementById("pt4").value);
	document.getElementById("wt04").value=wt4;
	document.getElementById("pt04").value=pt4;

	var wt5=parseInt(document.getElementById("wt5").value);
	var pt5=parseInt(document.getElementById("pt5").value);
	document.getElementById("wt05").value=wt5;
	document.getElementById("pt05").value=pt5;
}
...
function result1(){
  ...
  var ev;
	...
	// document.getElementById("ab").value=pr;
	var rs1=parseFloat(document.getElementById("rs1").value);
    if(rs1==pr){
		alert("Correct Answer Click on next");
		document.getElementById("st1").value=pr;
